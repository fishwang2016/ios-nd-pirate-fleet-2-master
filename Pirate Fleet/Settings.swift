...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You just hit a big monister! RIGHT NOW THE COMPUTER WILL JUST TAKE AN EXTRA TURN..."
        static let ComputerHitMonster = "Computer awoke! a monister!!!RIGHT NOW WE'LL JUST SKIP THE COMPUTER'S NEXT TURN..."
